 ...
 *
 * This file contains the law metadata and selected sections for the Constitution.
 * Sections are selected based on relevance to everyday scenarios.
 *
 * Source: https://placng.org/i/wp-content/uploads/2023/11/Constitution-of-the-Federal-Republic-of-Nigeria-1999-Updated.pdf
 */

import { LawCategory } from '@prisma/client';
import type { LawWithSections } from '../types';

export const constitution: LawWithSections = {
  law: {
    ...
    sourceUrl:
      'https://placng.org/i/wp-content/uploads/2023/11/Constitution-of-the-Federal-Republic-of-Nigeria-1999-Updated.pdf',
    isActive: true,
  },
  sections: [
    // Chapter IV - Fundamental Rights (Sections 33-46)
    {
      slug: 'section-33',
      number: '33',
      title: 'Right to Life',
    ...
    },
    {
      ...
      summary:
        'Ensures the right to fair trial and due process. Includes presumption of innocence, right to legal representation, right to be informed of charges, and protection against double jeopardy.',
      orderIndex: 36,
    },
    {
      slug: 'section-37',
    ...
    },
    {
      ...
      summary:
        'Guarantees freedom of religion, thought, and conscience. Protects right to practice and propagate religion.',
      orderIndex: 38,
    },
    {
      slug: 'section-39',
      ...
      summary:
        'Protects freedom of speech, press, and the right to receive and share information. Includes right to own media outlets subject to regulations.',
      orderIndex: 39,
    },
    {
      slug: 'section-40',
      ...
      summary:
        'Guarantees freedom of assembly and association, including right to form or join political parties and trade unions.',
      orderIndex: 40,
    },
    {
      slug: 'section-41',
      ...
      summary:
        'Guarantees freedom of movement within Nigeria and the right not to be expelled or refused entry.',
      orderIndex: 41,
    },
    {
      slug: 'section-42',
      ...
      summary:
        'Prohibits discrimination based on ethnic group, place of origin, sex, religion, or political opinion.',
      orderIndex: 42,
    },
    {
      slug: 'section-43',
      ...
      summary: 'Guarantees right of citizens to own property anywhere in Nigeria.',
      orderIndex: 43,
    },
    {
      slug: 'section-44',
